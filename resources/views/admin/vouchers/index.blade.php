...
@section('content')
    <a href="{{route('admin.vouchers.create')}}" class="mb-3">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input type="checkbox" class="js-switch active" data-model="{{ $item->is_active }}"
                                        ...
                                        data-modelId="{{ $item->id }}" data-title="{{ $item->code }}" @if(Auth::user()->role != 2) disabled @endif/>
                                </td>
                                <td>
                                    <a class="btn btn-primary mr-2" href="{{route('admin.vouchers.show', $item)}}" title="Xem chi tiết"><i class="fa fa-eye"></i></a>
                                    <a class="btn btn-warning mr-2" href="{{route('admin.vouchers.edit', $item)}}" title="Sửa"><i class="fa fa-edit"></i></a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Bạn có muốn xóa voucher "{{ $item->code }}" không?
                                        </div>
...
<script src="{{ asset('ajax/changeActive/Voucher/changeActiveVoucher.js') }}"></script>
<script src="{{ asset('ajax/changeActive/Voucher/changeAllActiveVoucher.js') }}"></script>
@endsection