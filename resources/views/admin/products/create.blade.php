                ...
                <div class="collapse show" id="collapseProductInfo">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="img_thumb" name="img_thumb" required>
                            @error('img_thumb')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="gallery" name="product_galleries[]" multiple required>
