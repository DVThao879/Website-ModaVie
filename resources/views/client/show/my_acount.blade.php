                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4">
                            <div class="myaccount-tab-menu nav" role="tablist">
                                ...
                                <a href="#account-info" class="active" data-bs-toggle="tab"><i class="fa fa-user"></i>Thông Tin Cá
                                    Nhân</a>
                                <a href="#orders" data-bs-toggle="tab"><i class="fa fa-user"></i>Sản Phẩm Yêu Thích</a>

                                <a href="#reset-password" data-bs-toggle="tab" ><i class="fa fa-sign-out"></i>Đổi mật khẩu</a>
                            </div>
                        </div>
                                                ...
                                                <form
                                                    ...
                                                    <fieldset>
                                                        <div class="single-input-item">
                                                            ...
                                                            <input type="password" id="current-pwd" name="current_password" value="{{old('current_password')}}"/>
